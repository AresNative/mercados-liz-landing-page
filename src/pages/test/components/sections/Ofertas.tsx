  ...
  return (
    <div className="p-4 sm:p-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6">
        {[1, 2, 3].map((item) => (
          <div key={item} className="bg-purple-50 min-h-full border border-purple-200 rounded-lg p-4 sm:p-6 flex flex-col items-center hover:shadow-md transition-shadow duration-300">
