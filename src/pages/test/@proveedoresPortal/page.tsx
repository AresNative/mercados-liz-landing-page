...
import { ProveedoresPortalField } from "../constants/proveedoresPortal";
...
export default function PageProveedoresPortal() {
    ...
    return (
        <Body>
            <section className="w-4/5 m-auto" >
                <h1>Formato de subida para proveedoresPortal</h1>
                <MainForm
                    formatForm="ProveedoresPortalData"
